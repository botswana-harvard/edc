...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Review.revision'
        db.add_column(u'lab_clinic_api_review', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)
        ...
        db.add_column(u'lab_clinic_api_order', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'lab_clinic_api_aliquot', 'revision')

        # Deleting field 'Review.revision'
        db.delete_column(u'lab_clinic_api_review', 'revision')

        # Deleting field 'Receive.revision'
        db.delete_column(u'lab_clinic_api_receive', 'revision')

        # Deleting field 'Order.revision'
        db.delete_column(u'lab_clinic_api_order', 'revision')

        # Deleting field 'Result.revision'
        db.delete_column(u'lab_clinic_api_result', 'revision')

        # Deleting field 'ResultItem.revision'
        db.delete_column(u'lab_clinic_api_resultitem', 'revision')
    ...
    models = {
        ...
        'lab_clinic_api.aliquot': {
            ...
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 23, 0, 0)'}),
        ...
        'lab_clinic_api.receive': {
            ...
            'receive_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 23, 0, 0)', 'db_index': 'True'}),
