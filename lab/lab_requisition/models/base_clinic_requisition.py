...
class BaseClinicRequisition (BaseRequisition):
    ...
    def bypass_for_edit_dispatched_as_item(self):
        ...
        may_not_change_these_fields = [(k, v) for k, v in obj.__dict__.iteritems() if k not in ['is_receive', 'is_receive_datetime', 'specimen_identifier', 'is_packed', 'is_labelled', 'is_labelled_datetime', 'is_lis', 'packing_list', 'comment', 'modified', 'user_modified']]
