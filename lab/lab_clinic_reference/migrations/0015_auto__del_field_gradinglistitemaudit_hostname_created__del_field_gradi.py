...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GradingListItemAudit._audit_id'
        db.alter_column(u'lab_clinic_reference_gradinglistitem_audit', '_audit_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))
        ...
        # Changing field 'ReferenceRangeListItemAudit._audit_id'
        db.alter_column(u'lab_clinic_reference_referencerangelistitem_audit', '_audit_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'GradingListItemAudit._audit_id'
        db.alter_column(u'lab_clinic_reference_gradinglistitem_audit', '_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True))
        ...
        # Changing field 'ReferenceRangeListItemAudit._audit_id'
        db.alter_column(u'lab_clinic_reference_referencerangelistitem_audit', '_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True))
