...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'testing_testscheduledmodel1', (
            ...
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 1, 9, 0, 0))),
        ...
        # Changing field 'TestRequisition.specimen_identifier'
        db.alter_column(u'testing_testrequisition', 'specimen_identifier', self.gf('django.db.models.fields.CharField')(max_length=50, unique=True, null=True))

        # Changing field 'TestRequisition.revision'
        db.alter_column(u'testing_testrequisition', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestRequisition.requisition_identifier'
        db.alter_column(u'testing_testrequisition', 'requisition_identifier', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50))

        # Changing field 'TestRequisitionAudit.specimen_identifier'
        db.alter_column(u'testing_testrequisition_audit', 'specimen_identifier', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestRequisitionAudit.revision'
        db.alter_column(u'testing_testrequisition_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestRequisitionAudit.requisition_identifier'
        db.alter_column(u'testing_testrequisition_audit', 'requisition_identifier', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'TestDspItem.revision'
        db.alter_column(u'testing_testdspitem', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))
        # Adding field 'TestSubjectLocator.may_sms_follow_up'
        db.add_column(u'testing_testsubjectlocator', 'may_sms_follow_up',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True),
                      keep_default=False)


        # Changing field 'TestSubjectLocator.revision'
        db.alter_column(u'testing_testsubjectlocator', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestDspItemAudit.revision'
        db.alter_column(u'testing_testdspitem_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'ExportTest.revision'
        db.alter_column(u'testing_exporttest', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestSubjectVisitThree.revision'
        db.alter_column(u'testing_testsubjectvisitthree', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestBaseOffStudyAudit.revision'
        db.alter_column(u'testing_testbaseoffstudy_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestDspItemBypass.revision'
        db.alter_column(u'testing_testdspitembypass', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestDspContainer.revision'
        db.alter_column(u'testing_testdspcontainer', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestSubjectUuidModel.revision'
        db.alter_column(u'testing_testsubjectuuidmodel', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestBaseOffStudy.revision'
        db.alter_column(u'testing_testbaseoffstudy', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestDspItemThree.revision'
        db.alter_column(u'testing_testdspitemthree', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestVisit.revision'
        db.alter_column(u'testing_testvisit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestDspItemM2MAudit.revision'
        db.alter_column(u'testing_testdspitemm2m_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestConsent.revision'
        db.alter_column(u'testing_testconsent', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestModel.revision'
        db.alter_column(u'testing_testmodel', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestSubjectVisitTwo.revision'
        db.alter_column(u'testing_testsubjectvisittwo', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestRegistration.revision'
        db.alter_column(u'testing_testregistration', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestConsentWithMixin.revision'
        db.alter_column(u'testing_testconsentwithmixin', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestDspItemThreeAudit.revision'
        db.alter_column(u'testing_testdspitemthree_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestConsentNoRs.revision'
        db.alter_column(u'testing_testconsentnors', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestOffStudy.revision'
        db.alter_column(u'testing_testoffstudy', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestDspItemTwo.revision'
        db.alter_column(u'testing_testdspitemtwo', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestDspContainerAudit.revision'
        db.alter_column(u'testing_testdspcontainer_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestConsentHistory.revision'
        db.alter_column(u'testing_testconsenthistory', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestDspItemTwoAudit.revision'
        db.alter_column(u'testing_testdspitemtwo_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestSubjectVisit.revision'
        db.alter_column(u'testing_testsubjectvisit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestScheduledModel.revision'
        db.alter_column(u'testing_testscheduledmodel', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestDspItemBypassAudit.revision'
        db.alter_column(u'testing_testdspitembypass_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestDspItemM2M.revision'
        db.alter_column(u'testing_testdspitemm2m', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'TestSubjectResultModel.revision'
        db.alter_column(u'testing_testsubjectresultmodel', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'TestRequisition.specimen_identifier'
        db.alter_column(u'testing_testrequisition', 'specimen_identifier', self.gf('django.db.models.fields.CharField')(unique=True, max_length=25, null=True))

        # Changing field 'TestRequisition.revision'
        db.alter_column(u'testing_testrequisition', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestRequisition.requisition_identifier'
        db.alter_column(u'testing_testrequisition', 'requisition_identifier', self.gf('django.db.models.fields.CharField')(max_length=25, unique=True))

        # Changing field 'TestRequisitionAudit.specimen_identifier'
        db.alter_column(u'testing_testrequisition_audit', 'specimen_identifier', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'TestRequisitionAudit.revision'
        db.alter_column(u'testing_testrequisition_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestRequisitionAudit.requisition_identifier'
        db.alter_column(u'testing_testrequisition_audit', 'requisition_identifier', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'TestDspItem.revision'
        db.alter_column(u'testing_testdspitem', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
        # Deleting field 'TestSubjectLocator.may_sms_follow_up'
        db.delete_column(u'testing_testsubjectlocator', 'may_sms_follow_up')


        # Changing field 'TestSubjectLocator.revision'
        db.alter_column(u'testing_testsubjectlocator', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestDspItemAudit.revision'
        db.alter_column(u'testing_testdspitem_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'ExportTest.revision'
        db.alter_column(u'testing_exporttest', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestSubjectVisitThree.revision'
        db.alter_column(u'testing_testsubjectvisitthree', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestBaseOffStudyAudit.revision'
        db.alter_column(u'testing_testbaseoffstudy_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestDspItemBypass.revision'
        db.alter_column(u'testing_testdspitembypass', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestDspContainer.revision'
        db.alter_column(u'testing_testdspcontainer', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestSubjectUuidModel.revision'
        db.alter_column(u'testing_testsubjectuuidmodel', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestBaseOffStudy.revision'
        db.alter_column(u'testing_testbaseoffstudy', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestDspItemThree.revision'
        db.alter_column(u'testing_testdspitemthree', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestVisit.revision'
        db.alter_column(u'testing_testvisit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestDspItemM2MAudit.revision'
        db.alter_column(u'testing_testdspitemm2m_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestConsent.revision'
        db.alter_column(u'testing_testconsent', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestModel.revision'
        db.alter_column(u'testing_testmodel', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestSubjectVisitTwo.revision'
        db.alter_column(u'testing_testsubjectvisittwo', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestRegistration.revision'
        db.alter_column(u'testing_testregistration', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestConsentWithMixin.revision'
        db.alter_column(u'testing_testconsentwithmixin', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestDspItemThreeAudit.revision'
        db.alter_column(u'testing_testdspitemthree_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestConsentNoRs.revision'
        db.alter_column(u'testing_testconsentnors', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestOffStudy.revision'
        db.alter_column(u'testing_testoffstudy', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestDspItemTwo.revision'
        db.alter_column(u'testing_testdspitemtwo', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestDspContainerAudit.revision'
        db.alter_column(u'testing_testdspcontainer_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestConsentHistory.revision'
        db.alter_column(u'testing_testconsenthistory', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestDspItemTwoAudit.revision'
        db.alter_column(u'testing_testdspitemtwo_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestSubjectVisit.revision'
        db.alter_column(u'testing_testsubjectvisit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestScheduledModel.revision'
        db.alter_column(u'testing_testscheduledmodel', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestDspItemBypassAudit.revision'
        db.alter_column(u'testing_testdspitembypass_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestDspItemM2M.revision'
        db.alter_column(u'testing_testdspitemm2m', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TestSubjectResultModel.revision'
        db.alter_column(u'testing_testsubjectresultmodel', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        'testing.exporttest': {
            ...
            'f_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 9, 0, 0)'}),
            'f_datetime': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 9, 0, 0)'}),
        ...
        'testing.testscheduledmodel': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 9, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
        ...
        'testing.testsubjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 9, 0, 0)'}),
