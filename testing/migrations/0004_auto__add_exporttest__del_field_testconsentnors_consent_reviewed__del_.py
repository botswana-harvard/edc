...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'testing_exporttest', (
            ...
            ('f_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 10, 30, 0, 0))),
            ('f_datetime', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 10, 30, 0, 0))),
        ...
        # Deleting field 'TestConsentNoRs.consent_reviewed'
        db.delete_column(u'testing_testconsentnors', 'consent_reviewed')

        # Deleting field 'TestConsentNoRs.assessment_score'
        db.delete_column(u'testing_testconsentnors', 'assessment_score')

        # Deleting field 'TestConsentNoRs.consent_copy'
        db.delete_column(u'testing_testconsentnors', 'consent_copy')

        # Deleting field 'TestConsentNoRs.study_questions'
        db.delete_column(u'testing_testconsentnors', 'study_questions')

        # Adding field 'TestScheduledModel.report_datetime'
        db.add_column(u'testing_testscheduledmodel', 'report_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 10, 30, 0, 0)),
                      keep_default=False)

        # Adding field 'TestScheduledModel.f1'
        db.add_column(u'testing_testscheduledmodel', 'f1',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)

        # Adding field 'TestScheduledModel.f2'
        db.add_column(u'testing_testscheduledmodel', 'f2',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)

        # Adding field 'TestScheduledModel.f3'
        db.add_column(u'testing_testscheduledmodel', 'f3',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)

        # Adding field 'TestScheduledModel.f4'
        db.add_column(u'testing_testscheduledmodel', 'f4',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'TestConsentNoRs.consent_reviewed'
        db.add_column(u'testing_testconsentnors', 'consent_reviewed',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'TestConsentNoRs.assessment_score'
        db.add_column(u'testing_testconsentnors', 'assessment_score',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'TestConsentNoRs.consent_copy'
        db.add_column(u'testing_testconsentnors', 'consent_copy',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'TestConsentNoRs.study_questions'
        db.add_column(u'testing_testconsentnors', 'study_questions',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Deleting field 'TestScheduledModel.report_datetime'
        db.delete_column(u'testing_testscheduledmodel', 'report_datetime')

        # Deleting field 'TestScheduledModel.f1'
        db.delete_column(u'testing_testscheduledmodel', 'f1')

        # Deleting field 'TestScheduledModel.f2'
        db.delete_column(u'testing_testscheduledmodel', 'f2')

        # Deleting field 'TestScheduledModel.f3'
        db.delete_column(u'testing_testscheduledmodel', 'f3')

        # Deleting field 'TestScheduledModel.f4'
        db.delete_column(u'testing_testscheduledmodel', 'f4')
    ...
    models = {
        ...
        'testing.exporttest': {
            ...
            'f_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 30, 0, 0)'}),
            'f_datetime': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 30, 0, 0)'}),
        ...
        'testing.testscheduledmodel': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 30, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
        ...
        'testing.testsubjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 30, 0, 0)'}),
