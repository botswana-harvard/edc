...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NetbookImportError'
        db.create_table('bhp_netbook_netbookimporterror', (
            ...
            ('netbook', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('object_model_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('object_unicode', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('object_serialized', self.gf('django.db.models.fields.CharField')(max_length=4000)),
        ))
        db.send_create_signal('bhp_netbook', ['NetbookImportError'])


    def backwards(self, orm):
        
        # Deleting model 'NetbookImportError'
        db.delete_table('bhp_netbook_netbookimporterror')
    ...
    models = {
        ...
        'bhp_netbook.netbookimporterror': {
            'Meta': {'object_name': 'NetbookImportError'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'home'", 'max_length': '50', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'home'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'netbook': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'object_model_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'object_serialized': ('django.db.models.fields.CharField', [], {'max_length': '4000'}),
            'object_unicode': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'})
        },
