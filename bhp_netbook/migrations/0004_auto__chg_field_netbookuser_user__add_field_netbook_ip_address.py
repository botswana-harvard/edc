...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NetbookUser.user'
        db.alter_column('bhp_netbook_netbookuser', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Adding field 'Netbook.ip_address'
        db.add_column('bhp_netbook_netbook', 'ip_address', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'NetbookUser.user'
        raise RuntimeError("Cannot reverse this migration. 'NetbookUser.user' and its values cannot be restored.")

        # Deleting field 'Netbook.ip_address'
        db.delete_column('bhp_netbook_netbook', 'ip_address')
