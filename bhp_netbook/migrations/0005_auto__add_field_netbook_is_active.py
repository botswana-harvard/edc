...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Netbook.is_active'
        db.add_column('bhp_netbook_netbook', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Netbook.is_active'
        db.delete_column('bhp_netbook_netbook', 'is_active')
