...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Netbook'
        db.create_table('bhp_netbook_netbook', (
            ...
            ('serial_number', self.gf('django.db.models.fields.CharField')(unique=True, max_length=25)),
        ))
        db.send_create_signal('bhp_netbook', ['Netbook'])

        # Adding model 'NetbookUser'
        db.create_table('bhp_netbook_netbookuser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
        ...
        db.send_create_signal('bhp_netbook', ['NetbookUser'])

        # Adding unique constraint on 'NetbookUser', fields ['netbook', 'user']
        db.create_unique('bhp_netbook_netbookuser', ['netbook_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'NetbookUser', fields ['netbook', 'user']
        db.delete_unique('bhp_netbook_netbookuser', ['netbook_id', 'user_id'])

        # Deleting model 'Netbook'
        db.delete_table('bhp_netbook_netbook')

        # Deleting model 'NetbookUser'
        db.delete_table('bhp_netbook_netbookuser')
