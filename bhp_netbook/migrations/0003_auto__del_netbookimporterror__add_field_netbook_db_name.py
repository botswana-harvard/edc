...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Netbook.db_name'
        db.add_column('bhp_netbook_netbook', 'db_name', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Netbook.db_name'
        db.delete_column('bhp_netbook_netbook', 'db_name')
