...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bhp_netbook_svnhistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('netbook', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_netbook.Netbook'])),
            ('repo', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('last_revision_number', self.gf('django.db.models.fields.CharField')(max_length=10, null=True)),
            ('last_revision_date', self.gf('django.db.models.fields.CharField')(max_length=25, null=True)),
        ))
        db.send_create_signal('bhp_netbook', ['SvnHistory'])


    def backwards(self, orm):
        
        # Deleting model 'SvnHistory'
        db.delete_table('bhp_netbook_svnhistory')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 24, 9, 31, 8, 270091)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 24, 9, 31, 8, 269989)'}),
        ...
        'bhp_netbook.svnhistory': {
            ...
            'last_revision_number': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True'}),
            'netbook': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_netbook.Netbook']"}),
