...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Netbook.last_seen'
        db.add_column('bhp_netbook_netbook', 'last_seen', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Netbook.last_seen'
        db.delete_column('bhp_netbook_netbook', 'last_seen')
