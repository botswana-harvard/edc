...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'sync_transaction')


    def backwards(self, orm):
        # Adding model 'Transaction'
        db.create_table(u'sync_transaction', (
            ...
            ('consumer', self.gf('django.db.models.fields.CharField')(blank=True, max_length=25, null=True, db_index=True)),
            ('batch_seq', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ))
        db.send_create_signal('sync', ['Transaction'])
    ...
    models = {
        'sync.incomingtransaction': {
            ...
            'producer': ('django.db.models.fields.CharField', [], {'default': "'mac.local-bhp066_reorg'", 'max_length': '50', 'db_index': 'True'}),
        ...
        'sync.requestlog': {
            ...
            'request_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 30, 0, 0)'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'complete'", 'max_length': '25'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
        'sync.syncimporthistorymodel': {
            'Meta': {'object_name': 'SyncImportHistoryModel', 'db_table': "'bhp_sync_syncimporthistorymodel'"},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        'sync.synclockmodel': {
            'Meta': {'object_name': 'SyncLockModel', 'db_table': "'bhp_sync_synclockmodel'"},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
