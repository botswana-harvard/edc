...
urlpatterns += patterns('',
    ...
    url(r'^view/(?P<app_label>\w+)/(?P<model_name>\w+)/(?P<pk>[\w]{8}-[\w]{4}-[\w]{4}-[\w]{4}-[\w]{12})/', view_transaction, name='view_transaction_url',),
    url(r'^view/(?P<model_name>\w+)/(?P<pk>[\w]{8}-[\w]{4}-[\w]{4}-[\w]{4}-[\w]{12})/', view_transaction, name='view_transaction_url',),
