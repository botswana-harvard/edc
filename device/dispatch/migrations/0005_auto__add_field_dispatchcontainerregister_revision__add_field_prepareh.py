...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DispatchContainerRegister.revision'
        db.add_column('bhp_dispatch_dispatchcontainerregister', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PrepareHistory.revision'
        db.add_column('bhp_dispatch_preparehistory', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DispatchItemRegister.revision'
        db.add_column('bhp_dispatch_dispatchitemregister', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DispatchContainerRegister.revision'
        db.delete_column('bhp_dispatch_dispatchcontainerregister', 'revision')

        # Deleting field 'PrepareHistory.revision'
        db.delete_column('bhp_dispatch_preparehistory', 'revision')

        # Deleting field 'DispatchItemRegister.revision'
        db.delete_column('bhp_dispatch_dispatchitemregister', 'revision')
    ...
    models = {
        'dispatch.dispatchcontainerregister': {
            ...
            'dispatch_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 23, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        'dispatch.preparehistory': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'prepare_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 23, 0, 0)'}),
            'producer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sync.Producer']"}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
