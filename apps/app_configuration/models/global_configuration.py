...
class GlobalConfiguration(BaseUuidModel):
    """A model to store any conigurations values for reference in the edc and other models.
    ...
    attribute = models.CharField(max_length=50, unique=True, validators=[RegexValidator('[a-z0-9_]', 'Invalid attribute name, must be lower case separated by underscore.'), ])
    value = models.CharField(max_length=50, help_text='any string value or string representation of a value')
