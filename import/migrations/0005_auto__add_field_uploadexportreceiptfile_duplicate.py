...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UploadExportReceiptFile.duplicate'
        db.add_column(u'import_uploadexportreceiptfile', 'duplicate',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UploadExportReceiptFile.duplicate'
        db.delete_column(u'import_uploadexportreceiptfile', 'duplicate')
