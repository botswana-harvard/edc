...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'UploadSkipDays', fields ['skip_date']
        db.delete_unique(u'import_uploadskipdays', ['skip_date'])

        # Adding unique constraint on 'UploadSkipDays', fields ['identifier', 'skip_date']
        db.create_unique(u'import_uploadskipdays', ['identifier', 'skip_date'])


    def backwards(self, orm):
        # Removing unique constraint on 'UploadSkipDays', fields ['identifier', 'skip_date']
        db.delete_unique(u'import_uploadskipdays', ['identifier', 'skip_date'])

        # Adding unique constraint on 'UploadSkipDays', fields ['skip_date']
        db.create_unique(u'import_uploadskipdays', ['skip_date'])
