...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AdditionalEntryBucket.content_type_map'
        db.alter_column('bhp_form_additionalentrybucket', 'content_type_map_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_content_type_map.ContentTypeMap']))

        # Changing field 'Entry.content_type_map'
        db.alter_column('bhp_form_entry', 'content_type_map_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_content_type_map.ContentTypeMap']))


    def backwards(self, orm):
        
        # Changing field 'AdditionalEntryBucket.content_type_map'
        db.alter_column('bhp_form_additionalentrybucket', 'content_type_map_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_common.ContentTypeMap']))

        # Changing field 'Entry.content_type_map'
        db.alter_column('bhp_form_entry', 'content_type_map_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_common.ContentTypeMap']))
