...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Entry', fields ['entry_category']
        db.create_index('bhp_form_entry', ['entry_category'])


    def backwards(self, orm):
        # Removing index on 'Entry', fields ['entry_category']
        db.delete_index('bhp_form_entry', ['entry_category'])
