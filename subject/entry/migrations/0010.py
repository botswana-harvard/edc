...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('bhp_form_entry', 'bhp_entry_entry')
        db.rename_table('bhp_form_scheduledentrybucket', 'bhp_entry_scheduledentrybucket')
        db.rename_table('bhp_form_additionalentrybucket', 'bhp_entry_additionalentrybucket')
    ...
    models = {
        ...
        'bhp_visit.membershipform': {
            'Meta': {'object_name': 'MembershipForm', 'db_table': "'bhp_entry_membershipform'"},
        ...
        'bhp_visit.schedulegroup': {
            'Meta': {'ordering': "['group_name']", 'object_name': 'ScheduleGroup', 'db_table': "'bhp_entry_schedulegroup'"},
        ...
        'bhp_visit.visitdefinition': {
            'Meta': {'ordering': "['code', 'time_point']", 'object_name': 'VisitDefinition', 'db_table': "'bhp_entry_visitdefinition'"},
            'base_interval': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'base_interval_unit': ('django.db.models.fields.CharField', [], {'default': "'D'", 'max_length': '10'}),
