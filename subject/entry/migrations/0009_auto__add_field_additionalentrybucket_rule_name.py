...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdditionalEntryBucket.rule_name'
        db.add_column('bhp_form_additionalentrybucket', 'rule_name',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AdditionalEntryBucket.rule_name'
        db.delete_column('bhp_form_additionalentrybucket', 'rule_name')
    ...
    models = {
        ...
        'bhp_entry.additionalentrybucket': {
            ...
            'rule_name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'})
        },
        'bhp_entry.entry': {
