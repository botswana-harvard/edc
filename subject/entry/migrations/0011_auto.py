...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'AdditionalEntryBucket', fields ['rule_name']
        db.create_index('bhp_entry_additionalentrybucket', ['rule_name'])


    def backwards(self, orm):
        # Removing index on 'AdditionalEntryBucket', fields ['rule_name']
        db.delete_index('bhp_entry_additionalentrybucket', ['rule_name'])
