...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entry.revision'
        db.alter_column(u'entry_entry', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'LabEntry.revision'
        db.alter_column(u'entry_labentry', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'Entry.revision'
        db.alter_column(u'entry_entry', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'LabEntry.revision'
        db.alter_column(u'entry_labentry', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
