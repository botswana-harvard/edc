...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'AdditionalEntryBucket', fields ['hostname_created']
        db.create_index('bhp_form_additionalentrybucket', ['hostname_created'])

        # Adding index on 'AdditionalEntryBucket', fields ['hostname_modified']
        db.create_index('bhp_form_additionalentrybucket', ['hostname_modified'])

        # Adding index on 'Entry', fields ['hostname_created']
        db.create_index('bhp_form_entry', ['hostname_created'])
        ...
        db.create_index('bhp_form_scheduledentrybucket', ['registered_subject_id', 'appointment_id', 'entry_id'], unique=True)
    ...
    def backwards(self, orm):
        ...
        db.delete_index('bhp_form_entry', ['hostname_modified'])

        # Removing index on 'Entry', fields ['hostname_created']
        db.delete_index('bhp_form_entry', ['hostname_created'])

        # Removing index on 'AdditionalEntryBucket', fields ['hostname_modified']
        db.delete_index('bhp_form_additionalentrybucket', ['hostname_modified'])

        # Removing index on 'AdditionalEntryBucket', fields ['hostname_created']
        db.delete_index('bhp_form_additionalentrybucket', ['hostname_created'])
