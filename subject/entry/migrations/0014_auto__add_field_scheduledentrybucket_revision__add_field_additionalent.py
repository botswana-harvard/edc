...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AdditionalEntryBucket.revision'
        db.add_column('bhp_entry_additionalentrybucket', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Entry.revision'
        db.add_column('bhp_entry_entry', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('bhp_entry_additionalentrybucket', 'revision')

        # Deleting field 'Entry.revision'
        db.delete_column('bhp_entry_entry', 'revision')
