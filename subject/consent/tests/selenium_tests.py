...
from testing.models import TestSubjectUuidModel, TestForeignKey, TestM2m
...
class SeleniumTests(LiveServerTestCase, BaseMethods):
    ...
    def test_test_model(self):
        ...
        self.selenium.find_element_by_xpath('//a[@href="/admin/consent/testsubjectuuidmodel/add/"]').click()
