...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AttachedModelAudit.revision'
        db.add_column('bhp_consent_attachedmodel_audit', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AttachedModel.revision'
        db.add_column('bhp_consent_attachedmodel', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ConsentCatalogue.revision'
        db.add_column('bhp_consent_consentcatalogue', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ConsentCatalogueAudit.revision'
        db.add_column('bhp_consent_consentcatalogue_audit', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AttachedModelAudit.revision'
        db.delete_column('bhp_consent_attachedmodel_audit', 'revision')

        # Deleting field 'AttachedModel.revision'
        db.delete_column('bhp_consent_attachedmodel', 'revision')

        # Deleting field 'ConsentCatalogue.revision'
        db.delete_column('bhp_consent_consentcatalogue', 'revision')

        # Deleting field 'ConsentCatalogueAudit.revision'
        db.delete_column('bhp_consent_consentcatalogue_audit', 'revision')
