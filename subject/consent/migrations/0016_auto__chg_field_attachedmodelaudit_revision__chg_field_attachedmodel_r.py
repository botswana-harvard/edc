...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AttachedModelAudit.revision'
        db.alter_column('bhp_consent_attachedmodel_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'AttachedModel.revision'
        db.alter_column('bhp_consent_attachedmodel', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'ConsentCatalogue.revision'
        db.alter_column('bhp_consent_consentcatalogue', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'ConsentCatalogueAudit.revision'
        db.alter_column('bhp_consent_consentcatalogue_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'AttachedModelAudit.revision'
        db.alter_column('bhp_consent_attachedmodel_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'AttachedModel.revision'
        db.alter_column('bhp_consent_attachedmodel', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'ConsentCatalogue.revision'
        db.alter_column('bhp_consent_consentcatalogue', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'ConsentCatalogueAudit.revision'
        db.alter_column('bhp_consent_consentcatalogue_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
