...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bhp_consent_testsubjectuuidmodel_test_many_to_many', (
        ...
        db.create_unique('bhp_consent_testsubjectuuidmodel_test_many_to_many', ['testsubjectuuidmodel_id', 'testmanytomany_id'])

        # Adding field 'TestSubjectConsent.consent_reviewed'
        db.add_column('bhp_consent_testsubjectconsent', 'consent_reviewed',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'TestSubjectConsent.study_questions'
        db.add_column('bhp_consent_testsubjectconsent', 'study_questions',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'TestSubjectConsent.assessment_score'
        db.add_column('bhp_consent_testsubjectconsent', 'assessment_score',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'TestSubjectConsent.consent_copy'
        db.add_column('bhp_consent_testsubjectconsent', 'consent_copy',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'TestSubjectConsent.registered_subject'
        db.add_column('bhp_consent_testsubjectconsent', 'registered_subject',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bhp_registration.RegisteredSubject'], unique=True, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table('bhp_consent_testsubjectuuidmodel_test_many_to_many')

        # Deleting field 'TestSubjectConsent.consent_reviewed'
        db.delete_column('bhp_consent_testsubjectconsent', 'consent_reviewed')

        # Deleting field 'TestSubjectConsent.study_questions'
        db.delete_column('bhp_consent_testsubjectconsent', 'study_questions')

        # Deleting field 'TestSubjectConsent.assessment_score'
        db.delete_column('bhp_consent_testsubjectconsent', 'assessment_score')

        # Deleting field 'TestSubjectConsent.consent_copy'
        db.delete_column('bhp_consent_testsubjectconsent', 'consent_copy')

        # Deleting field 'TestSubjectConsent.registered_subject'
        db.delete_column('bhp_consent_testsubjectconsent', 'registered_subject_id')
