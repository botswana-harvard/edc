...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SimpleAdverseEvent.revision'
        db.add_column('bhp_adverse_simpleadverseevent', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SimpleAdverseEvent.revision'
        db.delete_column('bhp_adverse_simpleadverseevent', 'revision')
