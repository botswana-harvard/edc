...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PreAppointmentContact.revision'
        db.alter_column('bhp_appointment_preappointmentcontact', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'Holiday.revision'
        db.alter_column('bhp_appointment_holiday', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'Appointment.revision'
        db.alter_column('bhp_appointment_appointment', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'AppointmentAudit.revision'
        db.alter_column('bhp_appointment_appointment_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'PreAppointmentContactAudit.revision'
        db.alter_column('bhp_appointment_preappointmentcontact_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'Configuration.revision'
        db.alter_column('bhp_appointment_configuration', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'PreAppointmentContact.revision'
        db.alter_column('bhp_appointment_preappointmentcontact', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Holiday.revision'
        db.alter_column('bhp_appointment_holiday', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Appointment.revision'
        db.alter_column('bhp_appointment_appointment', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'AppointmentAudit.revision'
        db.alter_column('bhp_appointment_appointment_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'PreAppointmentContactAudit.revision'
        db.alter_column('bhp_appointment_preappointmentcontact_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Configuration.revision'
        db.alter_column('bhp_appointment_configuration', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        'appointment.configuration': {
            'Meta': {'object_name': 'Configuration', 'db_table': "'bhp_appointment_configuration'"},
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'use_same_weekday': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'max_length': '3'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
        'appointment.holiday': {
