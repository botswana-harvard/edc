...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AdditionalAppointmentLabEntry'
        db.create_table('bhp_appointment_additionalappointmentlabentry', (
            ...
            ('lab_entry_id', self.gf('django.db.models.fields.CharField')(max_length=35)),
            ('panel_edc_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('appointment', ['AdditionalAppointmentLabEntry'])


    def backwards(self, orm):
        # Deleting model 'AdditionalAppointmentLabEntry'
        db.delete_table('bhp_appointment_additionalappointmentlabentry')


    models = {
        'appointment.additionalappointmentlabentry': {
            'Meta': {'object_name': 'AdditionalAppointmentLabEntry', 'db_table': "'bhp_appointment_additionalappointmentlabentry'"},
            ...
            'lab_entry_id': ('django.db.models.fields.CharField', [], {'max_length': '35'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'panel_edc_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
