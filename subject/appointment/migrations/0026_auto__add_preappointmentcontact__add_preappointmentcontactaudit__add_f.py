...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Appointment.appt_close_datetime'
        db.add_column('bhp_appointment_appointment', 'appt_close_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AppointmentAudit.appt_close_datetime'
        db.delete_column('bhp_appointment_appointment_audit', 'appt_close_datetime')

        # Deleting field 'Appointment.appt_close_datetime'
        db.delete_column('bhp_appointment_appointment', 'appt_close_datetime')
