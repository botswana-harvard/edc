...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AppointmentAudit._audit_subject_identifier'
        #db.delete_column('bhp_appointment_appointment_audit', '_audit_subject_identifier')

        # Deleting field 'PreAppointmentContactAudit._audit_subject_identifier'
        #db.delete_column('bhp_appointment_preappointmentcontact_audit', '_audit_subject_identifier')
        pass

    def backwards(self, orm):
        # Adding field 'AppointmentAudit._audit_subject_identifier'
        db.add_column('bhp_appointment_appointment_audit', '_audit_subject_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'PreAppointmentContactAudit._audit_subject_identifier'
        db.add_column('bhp_appointment_preappointmentcontact_audit', '_audit_subject_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)
