...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubjectConfiguration.revision'
        db.add_column('bhp_subject_config_subjectconfiguration', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubjectConfiguration.revision'
        db.delete_column('bhp_subject_config_subjectconfiguration', 'revision')
