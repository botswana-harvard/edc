...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WcsDxAdult.list_ref'
        db.alter_column('bhp_code_lists_wcsdxadult', 'list_ref', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'WcsDxPed.list_ref'
        db.alter_column('bhp_code_lists_wcsdxped', 'list_ref', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'WcsDxAdult.list_ref'
        db.alter_column('bhp_code_lists_wcsdxadult', 'list_ref', self.gf('django.db.models.fields.CharField')(max_length=35))

        # Changing field 'WcsDxPed.list_ref'
        db.alter_column('bhp_code_lists_wcsdxped', 'list_ref', self.gf('django.db.models.fields.CharField')(max_length=35))
    ...
    models = {
        'code_lists.arvcode': {
            ...
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'cabel'", 'max_length': '50', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'cabel'", 'max_length': '50', 'blank': 'True'}),
