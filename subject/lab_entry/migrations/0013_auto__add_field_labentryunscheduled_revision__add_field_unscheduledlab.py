...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LabEntryUnscheduled.revision'
        db.add_column('bhp_lab_entry_labentryunscheduled', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UnscheduledLabEntryBucket.revision'
        db.add_column('bhp_lab_entry_unscheduledlabentrybucket', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ScheduledLabEntryBucket.revision'
        db.add_column('bhp_lab_entry_scheduledlabentrybucket', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AdditionalLabEntryBucket.revision'
        db.add_column('bhp_lab_entry_additionallabentrybucket', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LabEntry.revision'
        db.add_column('bhp_lab_entry_labentry', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LabEntryUnscheduled.revision'
        db.delete_column('bhp_lab_entry_labentryunscheduled', 'revision')

        # Deleting field 'UnscheduledLabEntryBucket.revision'
        db.delete_column('bhp_lab_entry_unscheduledlabentrybucket', 'revision')

        # Deleting field 'ScheduledLabEntryBucket.revision'
        db.delete_column('bhp_lab_entry_scheduledlabentrybucket', 'revision')

        # Deleting field 'AdditionalLabEntryBucket.revision'
        db.delete_column('bhp_lab_entry_additionallabentrybucket', 'revision')

        # Deleting field 'LabEntry.revision'
        db.delete_column('bhp_lab_entry_labentry', 'revision')
    ...
    models = {
        ...
        'lab_entry.additionallabentrybucket': {
            'Meta': {'ordering': "['registered_subject', 'lab_entry_unscheduled__panel__name']", 'unique_together': "(['appointment', 'lab_entry_unscheduled'],)", 'object_name': 'AdditionalLabEntryBucket', 'db_table': "'bhp_lab_entry_additionallabentrybucket'"},
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'silverapple'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'lab_entry_unscheduled': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lab_entry.LabEntryUnscheduled']"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['registration.RegisteredSubject']"}),
        ...
        'lab_entry.labentry': {
            'Meta': {'ordering': "['visit_definition__code', 'entry_order']", 'unique_together': "(['visit_definition', 'panel'],)", 'object_name': 'LabEntry', 'db_table': "'bhp_lab_entry_labentry'"},
        ...
        'lab_entry.labentryunscheduled': {
            'Meta': {'ordering': "['panel', 'entry_order']", 'object_name': 'LabEntryUnscheduled', 'db_table': "'bhp_lab_entry_labentryunscheduled'"},
            'base_interval': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'base_interval_unit': ('django.db.models.fields.CharField', [], {'default': "'D'", 'max_length': '10'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'default_entry_status': ('django.db.models.fields.CharField', [], {'default': "'NEW'", 'max_length': '25'}),
        ...
        'lab_entry.scheduledlabentrybucket': {
            'Meta': {'ordering': "['registered_subject', 'lab_entry__panel__name', 'appointment']", 'unique_together': "(['registered_subject', 'lab_entry', 'appointment'],)", 'object_name': 'ScheduledLabEntryBucket', 'db_table': "'bhp_lab_entry_scheduledlabentrybucket'"},
            'appointment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['appointment.Appointment']"}),
            'close_datetime': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'current_entry_title': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True'}),
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'silverapple'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'lab_entry': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lab_entry.LabEntry']"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['registration.RegisteredSubject']"}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
        ...
        'lab_entry.unscheduledlabentrybucket': {
            'Meta': {'ordering': "['registered_subject', 'lab_entry_unscheduled__panel__name', 'appointment']", 'unique_together': "(['registered_subject', 'lab_entry_unscheduled', 'appointment'],)", 'object_name': 'UnscheduledLabEntryBucket', 'db_table': "'bhp_lab_entry_unscheduledlabentrybucket'"},
            'appointment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['appointment.Appointment']"}),
            'close_datetime': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'current_entry_title': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True'}),
