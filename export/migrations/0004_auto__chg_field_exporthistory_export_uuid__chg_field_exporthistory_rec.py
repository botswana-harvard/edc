...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExportHistory.export_uuid'
        db.alter_column(u'export_exporthistory', 'export_uuid', self.gf('django.db.models.fields.CharField')(max_length=36))

        # Changing field 'ExportHistory.received_datetime'
        db.alter_column(u'export_exporthistory', 'received_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'ExportHistory.sent_datetime'
        db.alter_column(u'export_exporthistory', 'sent_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'ExportHistory.export_uuid'
        db.alter_column(u'export_exporthistory', 'export_uuid', self.gf('django.db.models.fields.CharField')(max_length=32))

        # User chose to not deal with backwards NULL issues for 'ExportHistory.received_datetime'
        raise RuntimeError("Cannot reverse this migration. 'ExportHistory.received_datetime' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'ExportHistory.received_datetime'
        db.alter_column(u'export_exporthistory', 'received_datetime', self.gf('django.db.models.fields.DateTimeField')())

        # User chose to not deal with backwards NULL issues for 'ExportHistory.sent_datetime'
        raise RuntimeError("Cannot reverse this migration. 'ExportHistory.sent_datetime' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'ExportHistory.sent_datetime'
        db.alter_column(u'export_exporthistory', 'sent_datetime', self.gf('django.db.models.fields.DateTimeField')())
