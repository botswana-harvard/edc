...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExportHistory.instance_pk'
        db.alter_column(u'export_exporthistory', 'instance_pk', self.gf('django.db.models.fields.CharField')(max_length=36))

    def backwards(self, orm):

        # Changing field 'ExportHistory.instance_pk'
        db.alter_column(u'export_exporthistory', 'instance_pk', self.gf('django.db.models.fields.CharField')(max_length=32))
