...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExportHistory.change_type'
        db.alter_column(u'export_exporthistory', 'change_type', self.gf('django.db.models.fields.CharField')(max_length=2))

    def backwards(self, orm):

        # Changing field 'ExportHistory.change_type'
        db.alter_column(u'export_exporthistory', 'change_type', self.gf('django.db.models.fields.CharField')(max_length=1))
