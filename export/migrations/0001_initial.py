...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'export_exportplan', (
            ...
            ('target_path', self.gf('django.db.models.fields.CharField')(default='~/export', max_length=250)),
            ('notification_plan_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
        ))
        db.send_create_signal('export', ['ExportPlan'])
        ...
        db.send_create_signal('export', ['ExportReceipt'])
    ...
    models = {
        ...
        'export.exportplan': {
            ...
            'target_path': ('django.db.models.fields.CharField', [], {'default': "'~/export'", 'max_length': '250'}),
