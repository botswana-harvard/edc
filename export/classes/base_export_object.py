...
class BaseExportObject(object):

    def __init__(self, instances, filestub, fields=None, exclude=None, extra_fields=None,
        ...
        self.export_filename = '{0}_{1}.csv'.format(filestub, export_datetime.strftime('%Y%m%d%H%M%S'))
