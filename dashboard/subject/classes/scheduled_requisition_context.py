...
class ScheduledRequisitionContext(BaseScheduledEntryContext):
    ...
    def set_model_inst(self):
        """Sets to the model instance refered to by the scheduled lab entry."""
    ...
    def get_entry(self):
        """Sets to the LabEntry instance related to the scheduled entry."""
        return self.get_scheduled_entry().lab_entry
