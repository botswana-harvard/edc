...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubjectIdentifier.sequence_app_label'
    ...
    def backwards(self, orm):
        ...
        db.delete_column('bhp_identifier_subjectidentifier', 'sequence_app_label')

        # Deleting field 'SubjectIdentifier.sequence_model_name'
        db.delete_column('bhp_identifier_subjectidentifier', 'sequence_model_name')
    ...
    models = {
        ...
        'bhp_identifier.pendingidentifier': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'pending_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 29, 0, 0)'}),
