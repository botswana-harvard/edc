...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ContentTypeMap', fields ['name']
        db.delete_unique(u'bhp_content_type_map_contenttypemap', ['name'])


    def backwards(self, orm):
        pass
        # Adding unique constraint on 'ContentTypeMap', fields ['name']
        #db.create_unique(u'bhp_content_type_map_contenttypemap', ['name'])
