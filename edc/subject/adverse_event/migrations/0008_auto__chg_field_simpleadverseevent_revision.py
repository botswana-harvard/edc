...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SimpleAdverseEvent.revision'
        db.alter_column('bhp_adverse_simpleadverseevent', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'SimpleAdverseEvent.revision'
        db.alter_column('bhp_adverse_simpleadverseevent', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
