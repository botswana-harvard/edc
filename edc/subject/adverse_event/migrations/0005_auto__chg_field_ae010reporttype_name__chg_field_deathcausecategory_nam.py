...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ae010ReportType.name'
        db.alter_column('bhp_adverse_ae010reporttype', 'name', self.gf('django.db.models.fields.CharField')(max_length=250, unique=True, null=True))

        # Changing field 'DeathCauseCategory.name'
        db.alter_column('bhp_adverse_deathcausecategory', 'name', self.gf('django.db.models.fields.CharField')(max_length=250, unique=True, null=True))

        # Changing field 'AdverseEventReportType.name'
        db.alter_column('bhp_adverse_adverseeventreporttype', 'name', self.gf('django.db.models.fields.CharField')(max_length=250, unique=True, null=True))

        # Changing field 'DeathCauseInfo.name'
        db.alter_column('bhp_adverse_deathcauseinfo', 'name', self.gf('django.db.models.fields.CharField')(max_length=250, unique=True, null=True))

        # Changing field 'AdverseEventStudyRelation.name'
        db.alter_column('bhp_adverse_adverseeventstudyrelation', 'name', self.gf('django.db.models.fields.CharField')(max_length=250, unique=True, null=True))

        # Changing field 'DeathReasonHospitalized.name'
        db.alter_column('bhp_adverse_deathreasonhospitalized', 'name', self.gf('django.db.models.fields.CharField')(max_length=250, unique=True, null=True))

        # Changing field 'Ae010AdverseStudyRel.name'
        db.alter_column('bhp_adverse_ae010adversestudyrel', 'name', self.gf('django.db.models.fields.CharField')(max_length=250, unique=True, null=True))

        # Changing field 'DeathMedicalResponsibility.name'
        db.alter_column('bhp_adverse_deathmedicalresponsibility', 'name', self.gf('django.db.models.fields.CharField')(max_length=250, unique=True, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Ae010ReportType.name'
        raise RuntimeError("Cannot reverse this migration. 'Ae010ReportType.name' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'DeathCauseCategory.name'
        raise RuntimeError("Cannot reverse this migration. 'DeathCauseCategory.name' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'AdverseEventReportType.name'
        raise RuntimeError("Cannot reverse this migration. 'AdverseEventReportType.name' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'DeathCauseInfo.name'
        raise RuntimeError("Cannot reverse this migration. 'DeathCauseInfo.name' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'AdverseEventStudyRelation.name'
        raise RuntimeError("Cannot reverse this migration. 'AdverseEventStudyRelation.name' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'DeathReasonHospitalized.name'
        raise RuntimeError("Cannot reverse this migration. 'DeathReasonHospitalized.name' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Ae010AdverseStudyRel.name'
        raise RuntimeError("Cannot reverse this migration. 'Ae010AdverseStudyRel.name' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'DeathMedicalResponsibility.name'
        raise RuntimeError("Cannot reverse this migration. 'DeathMedicalResponsibility.name' and its values cannot be restored.")
