...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Link.revision'
        db.alter_column('bhp_subject_summary_link', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'Link.revision'
        db.alter_column('bhp_subject_summary_link', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    models = {
        'subject_summary.link': {
            'Meta': {'object_name': 'Link', 'db_table': "'bhp_subject_summary_link'"},
