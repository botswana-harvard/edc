...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Appendix40.revision'
        db.alter_column('bhp_actg_reference_appendix40', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'Appendix40.revision'
        db.alter_column('bhp_actg_reference_appendix40', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
