...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'lab_clinic_api_aliquot', 'primary_aliquot',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='primary', null=True, to=orm['lab_clinic_api.Aliquot']),
                      keep_default=False)

        # Adding field 'Aliquot.source_aliquot'
        db.add_column(u'lab_clinic_api_aliquot', 'source_aliquot',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='source', null=True, to=orm['lab_clinic_api.Aliquot']),
                      keep_default=False)

        # Adding field 'Aliquot.is_packed'
        db.add_column(u'lab_clinic_api_aliquot', 'is_packed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Removing index on 'Aliquot', fields ['receive_identifier']
#         db.delete_index(u'lab_clinic_api_aliquot', ['receive_identifier'])
# 
#         # Removing index on 'Aliquot', fields ['subject_identifier']
#         db.delete_index(u'lab_clinic_api_aliquot', ['subject_identifier'])
# 
#         # Adding unique constraint on 'Aliquot', fields ['receive', 'count']
        db.create_unique(u'lab_clinic_api_aliquot', ['receive_id', 'count'])
# 
#         # Adding unique constraint on 'Order', fields ['order_identifier']
        db.create_unique(u'lab_clinic_api_order', ['order_identifier'])


    def backwards(self, orm):
        # Removing unique constraint on 'Order', fields ['order_identifier']
        db.delete_unique(u'lab_clinic_api_order', ['order_identifier'])

        # Removing unique constraint on 'Aliquot', fields ['receive', 'count']
        db.delete_unique(u'lab_clinic_api_aliquot', ['receive_id', 'count'])

        # Adding index on 'Aliquot', fields ['subject_identifier']
        db.create_index(u'lab_clinic_api_aliquot', ['subject_identifier'])

        # Adding index on 'Aliquot', fields ['receive_identifier']
        db.create_index(u'lab_clinic_api_aliquot', ['receive_identifier'])

        # Deleting field 'Aliquot.primary_aliquot'
        db.delete_column(u'lab_clinic_api_aliquot', 'primary_aliquot_id')

        # Deleting field 'Aliquot.source_aliquot'
        db.delete_column(u'lab_clinic_api_aliquot', 'source_aliquot_id')

        # Deleting field 'Aliquot.is_packed'
        db.delete_column(u'lab_clinic_api_aliquot', 'is_packed')
    ...
    models = {
        ...
        'lab_clinic_api.aliquot': {
            ...
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 8, 0, 0)'}),
        ...
        'lab_clinic_api.receive': {
            ...
            'receive_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 8, 0, 0)', 'db_index': 'True'}),
