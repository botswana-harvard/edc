...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'lab_clinic_api_aliquot', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))
        ...
        db.alter_column(u'lab_clinic_api_receive', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))
        ...
        db.alter_column(u'lab_clinic_api_result', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'ResultItem.revision'
        db.alter_column(u'lab_clinic_api_resultitem', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'Aliquot.revision'
        db.alter_column(u'lab_clinic_api_aliquot', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Review.revision'
        db.alter_column(u'lab_clinic_api_review', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Receive.revision'
        db.alter_column(u'lab_clinic_api_receive', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Order.revision'
        db.alter_column(u'lab_clinic_api_order', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Result.revision'
        db.alter_column(u'lab_clinic_api_result', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'ResultItem.revision'
        db.alter_column(u'lab_clinic_api_resultitem', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        'lab_clinic_api.aliquot': {
            ...
            'aliquot_condition': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lab_clinic_api.AliquotCondition']", 'null': 'True'}),
