...
class Migration(DataMigration):
    ...
    models = {
        ...
        'dispenser.dispensing': {
            'Meta': {'object_name': 'Dispensing', 'db_table': "'ph_dispenser_dispensing'"},
            'copies': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'dispense_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 10, 0, 0)'}),
        ...
        'dispenser.dispensingidentifiermodel': {
            'Meta': {'ordering': "['-created']", 'object_name': 'DispensingIdentifierModel', 'db_table': "'ph_dispenser_dispensing_identifier_model'"},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        'dispenser.identifiersequence': {
            'Meta': {'object_name': 'IdentifierSequence', 'db_table': "'ph_dispenser_identifier_sequence'"},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
    ...
    complete_apps = ['dispenser', 'dispenser']
    symmetrical = True
