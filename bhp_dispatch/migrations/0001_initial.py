...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bhp_dispatch_dispatchcontainerregister', (
            ...
            ('dispatch_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 20, 0, 0), null=True, blank=True)),
        ...
        db.send_create_signal('bhp_dispatch', ['DispatchContainerRegister'])

        # Adding unique constraint on 'DispatchContainerRegister', fields ['container_app_label', 'container_model_name', 'container_pk']
        db.create_unique(u'bhp_dispatch_dispatchcontainerregister', ['container_app_label', 'container_model_name', 'container_pk'])

        # Adding model 'DispatchItemRegister'
        db.create_table(u'bhp_dispatch_dispatchitemregister', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('dispatch_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 20, 0, 0), null=True, blank=True)),
            ('return_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('dispatch_container_register', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_dispatch.DispatchContainerRegister'])),
        ...
        db.send_create_signal('bhp_dispatch', ['DispatchItemRegister'])
        ...
        db.create_table(u'bhp_dispatch_preparehistory', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('producer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_sync.Producer'])),
            ('prepare_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 20, 0, 0))),
        ))
        db.send_create_signal('bhp_dispatch', ['PrepareHistory'])

        # Adding model 'TestContainerAudit'
        db.create_table(u'bhp_dispatch_testcontainer_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.create_table(u'bhp_dispatch_testcontainer', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.create_table(u'bhp_dispatch_testlist', (
        ...
        db.send_create_signal('bhp_dispatch', ['TestList'])

        # Adding model 'TestItemAudit'
        db.create_table(u'bhp_dispatch_testitem_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('test_container', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_testitem', to=orm['bhp_dispatch.TestContainer'])),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ...
        db.create_table(u'bhp_dispatch_testitem', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('test_container', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_dispatch.TestContainer'])),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
        ))
        db.send_create_signal('bhp_dispatch', ['TestItem'])

        # Adding model 'TestItemTwoAudit'
        db.create_table(u'bhp_dispatch_testitemtwo_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('_audit_subject_identifier', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('test_item_identifier', self.gf('django.db.models.fields.CharField')(max_length=35)),
            ('test_item', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_testitemtwo', to=orm['bhp_dispatch.TestItem'])),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('bhp_dispatch', ['TestItemTwoAudit'])

        # Adding model 'TestItemTwo'
        db.create_table(u'bhp_dispatch_testitemtwo', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('test_item_identifier', self.gf('django.db.models.fields.CharField')(unique=True, max_length=35)),
            ('test_item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_dispatch.TestItem'])),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
        ))
        db.send_create_signal('bhp_dispatch', ['TestItemTwo'])

        # Adding model 'TestItemThreeAudit'
        db.create_table(u'bhp_dispatch_testitemthree_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('_audit_subject_identifier', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('test_item_identifier', self.gf('django.db.models.fields.CharField')(max_length=35)),
            ('test_item_two', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_testitemthree', to=orm['bhp_dispatch.TestItemTwo'])),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('bhp_dispatch', ['TestItemThreeAudit'])

        # Adding model 'TestItemThree'
        db.create_table(u'bhp_dispatch_testitemthree', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('test_item_identifier', self.gf('django.db.models.fields.CharField')(unique=True, max_length=35)),
            ('test_item_two', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_dispatch.TestItemTwo'])),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
        ))
        db.send_create_signal('bhp_dispatch', ['TestItemThree'])

        # Adding model 'TestItemM2MAudit'
        db.create_table(u'bhp_dispatch_testitemm2m_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('_audit_subject_identifier', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('test_item_identifier', self.gf('django.db.models.fields.CharField')(max_length=35)),
            ('test_item_three', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_testitemm2m', to=orm['bhp_dispatch.TestItemThree'])),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('bhp_dispatch', ['TestItemM2MAudit'])

        # Adding model 'TestItemM2M'
        db.create_table(u'bhp_dispatch_testitemm2m', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('test_item_identifier', self.gf('django.db.models.fields.CharField')(unique=True, max_length=35)),
            ('test_item_three', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_dispatch.TestItemThree'])),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
        ))
        db.send_create_signal('bhp_dispatch', ['TestItemM2M'])

        # Adding M2M table for field m2m on 'TestItemM2M'
        db.create_table(u'bhp_dispatch_testitemm2m_m2m', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('testitemm2m', models.ForeignKey(orm['bhp_dispatch.testitemm2m'], null=False)),
            ('testlist', models.ForeignKey(orm['bhp_dispatch.testlist'], null=False))
        ))
        db.create_unique(u'bhp_dispatch_testitemm2m_m2m', ['testitemm2m_id', 'testlist_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_unique(u'bhp_dispatch_dispatchitemregister', ['dispatch_container_register_id', 'item_pk', 'item_identifier', 'is_dispatched'])

        # Removing unique constraint on 'DispatchContainerRegister', fields ['container_app_label', 'container_model_name', 'container_pk']
        db.delete_unique(u'bhp_dispatch_dispatchcontainerregister', ['container_app_label', 'container_model_name', 'container_pk'])

        # Deleting model 'DispatchContainerRegister'
        db.delete_table(u'bhp_dispatch_dispatchcontainerregister')

        # Deleting model 'DispatchItemRegister'
        db.delete_table(u'bhp_dispatch_dispatchitemregister')

        # Deleting model 'PrepareHistory'
        db.delete_table(u'bhp_dispatch_preparehistory')

        # Deleting model 'TestContainerAudit'
        db.delete_table(u'bhp_dispatch_testcontainer_audit')

        # Deleting model 'TestContainer'
        db.delete_table(u'bhp_dispatch_testcontainer')

        # Deleting model 'TestList'
        db.delete_table(u'bhp_dispatch_testlist')

        # Deleting model 'TestItemAudit'
        db.delete_table(u'bhp_dispatch_testitem_audit')

        # Deleting model 'TestItem'
        db.delete_table(u'bhp_dispatch_testitem')

        # Deleting model 'TestItemTwoAudit'
        db.delete_table(u'bhp_dispatch_testitemtwo_audit')

        # Deleting model 'TestItemTwo'
        db.delete_table(u'bhp_dispatch_testitemtwo')

        # Deleting model 'TestItemThreeAudit'
        db.delete_table(u'bhp_dispatch_testitemthree_audit')

        # Deleting model 'TestItemThree'
        db.delete_table(u'bhp_dispatch_testitemthree')

        # Deleting model 'TestItemM2MAudit'
        db.delete_table(u'bhp_dispatch_testitemm2m_audit')

        # Deleting model 'TestItemM2M'
        db.delete_table(u'bhp_dispatch_testitemm2m')

        # Removing M2M table for field m2m on 'TestItemM2M'
        db.delete_table('bhp_dispatch_testitemm2m_m2m')
