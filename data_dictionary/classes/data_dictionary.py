...
class DataDictionary(object):
    ...
    def dictionary(self):
        ...
        app_label, model_name, db_table, field, db_field, prompt, type, max_length, default, null, blank, editable, help_text, encrypted, choices, primary_key, unique
        ...
        for model in self.models:
            ...
            if 'audit' not in model._meta.object_name.lower():
                ...
                for field in model._meta.fields:
                    ...
                    prompt = unicode(field.verbose_name)
                    ...
                    try:
                        default = unicode(field.default.func_name)
                    except:
                        pass
                    try:
                        default = unicode(field.default).split('.')[-1]
                    except:
                        pass
                    try:
                        default = unicode(field.default)
                    except:
