...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StudySpecific.revision'
        db.alter_column(u'bhp_variables_studyspecific', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'StudySite.revision'
        db.alter_column(u'bhp_variables_studysite', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'StudySpecific.revision'
        db.alter_column(u'bhp_variables_studyspecific', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'StudySite.revision'
        db.alter_column(u'bhp_variables_studysite', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
